...
const Orders: React.FC<OrdersProps> = ({ setView }) => {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case "Enviado":
        return <LocalShipping sx={{ fontSize: "1rem !important" }} />;
      case "En la Forja":
        return <Handyman sx={{ fontSize: "1rem !important" }} />;
      case "Limpieza y Curado":
        return <CleaningServices sx={{ fontSize: "1rem !important" }} />;
      case "Recibido":
        return <HourglassEmpty sx={{ fontSize: "1rem !important" }} />;
      case "Cancelado":
        return <Cancel sx={{ fontSize: "1rem !important" }} />;
      default:
        return undefined;
    }
  };
  ...
  const getStatusDescription = (status: string): string => {
    switch (status) {
      case "Recibido":
        return "Tu pedido ha sido recibido y está en cola para ser procesado.";
      case "En la Forja":
        return "Tu miniatura está siendo impresa en nuestra forja de resina.";
      case "Limpieza y Curado":
        return "La pieza está siendo curada con luz UV y limpiada de soportes.";
      case "Enviado":
        return "Tu paquete está en camino hacia tu fortaleza.";
      case "Cancelado":
      ...
      <Stack spacing={4}>
        {loading ? (
          ...
          >
            ...
            <Typography
              variant="h5"
              sx={{ fontWeight: "bold", color: "grey.300", mb: 1 }}
            >
              Cerrado a Extraños
            </Typography>
            <Typography
              variant="body2"
              sx={{ color: "grey.500", fontStyle: "italic", mb: 3 }}
            >
              Debes inscribir tu alma o identificarte para ver tus pergaminos de
              adquisición.
            </Typography>
            <Button
              variant="contained"
          ...
          >
            ...
            >
              Aún no has realizado ninguna requisición a la forja.
            </Typography>
          </Paper>
        ) : (
          orders.map((order) => (
            ...
            >
                ...
                >
                  ...
                  >
                    {orderSteps.map((label, index) => (
                      <Step
                        key={label}
                        completed={index <= getActiveStep(order.status)}
                      >
                        <StepLabel
                          StepIconProps={{
                            sx: {
              ...
              <Box
                sx={{
                  ...
                  py: 1.5,
                  borderTop: 1,
                  borderColor: (t) => alpha(t.palette.secondary.main, 0.05),
                  display: "flex",
