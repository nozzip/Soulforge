...
const LFGPostDetails: React.FC<LFGPostDetailsProps> = ({
  ...
  const handleApply = async () => {
    ...
    if (error) {
      ...
      if (error.code === "23503") {
        ...
        if (profileError) {
          ...
          setSnackbar({
            open: true,
            message:
              "Error: Your adventurer profile could not be created. Please contact support.",
            severity: "error",
          });
          return;
        }
        ...
        if (retryError) {
          ...
          setSnackbar({
            open: true,
            message: "Error applying: " + retryError.message,
            severity: "error",
          });
        } else {
          setSnackbar({
            open: true,
            message: "Application sent successfully! (Profile created)",
            severity: "success",
          });
          setHasApplied(true);
        }
      ...
      setSnackbar({
        open: true,
        message: "Error applying: " + error.message,
        severity: "error",
      });
    } else {
      setSnackbar({
