...
const LFGBoard: React.FC<LFGBoardProps> = ({ onBack }) => {
  ...
  const filteredPosts = posts.filter((post) => {
    ...
    const matchesSystem =
      filterSystem === "Todos" || post.system === filterSystem;
    const matchesModality =
      filterModality === "Todos" || post.modality === filterModality;
  ...
  const handleSubmit = async () => {
    if (!user) {
      setSnackbar({
        open: true,
        message: "Debes iniciar sesión para publicar un contrato.",
        severity: "error",
      });
      return;
    }
    ...
    if (error) {
      ...
      setSnackbar({
        open: true,
        message: "¡Contrato publicado exitosamente!",
        severity: "success",
      });
      fetchPosts();
      // Reset Form
    ...
    <Container maxWidth="xl" sx={{ mt: 14, mb: 10 }}>
      ...
      >
        ...
        >
          ...
          >
            "Se buscan héroes. La oscuridad se alza. Responde al llamado."
          </Typography>
          <Button
            onClick={onBack}
            sx={{
            ...
            >
              ...
              >
                ...
                <TextField
                  ...
                  placeholder="Nombra tu aventura..."
                  sx={{
                ...
                <Grid container spacing={2}>
                  <Grid size={{ xs: 6 }}>
                    ...
                    >
                      <InputLabel sx={{ color: "#9e9e9e" }}>Sistema</InputLabel>
                      <Select
          ...
          <Grid size={{ xs: 12, md: 8, lg: 9 }}>
            ...
            >
              ...
              <FormControl size="small" sx={{ minWidth: 150 }}>
                ...
                >
                  <MenuItem value="Todos">Todos los Sistemas</MenuItem>
                  {SYSTEMS.map((sys) => (
                    <MenuItem key={sys} value={sys}>
                      {sys}
                    </MenuItem>
              ...
              <FormControl size="small" sx={{ minWidth: 150 }}>
                <InputLabel sx={{ color: "#9e9e9e" }}>Modalidad</InputLabel>
                <Select
                ...
                >
                  <MenuItem value="Todos">Todas las Modalidades</MenuItem>
                  {MODALITIES.map((mod) => (
                    <MenuItem key={mod} value={mod}>
                      {mod}
                    </MenuItem>
              ...
              {filteredPosts.length === 0 ? (
                <Box sx={{ textAlign: "center", py: 8, opacity: 0.6 }}>
                  <Typography
                    ...
                    sx={{ color: "#d7ccc8" }}
                  >
                    No se encontraron misiones con tus criterios.
                  </Typography>
                </Box>
              ) : (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {post.slots_taken} / {post.slots_total} Héroes
                          </Typography>
                        </Box>
                      </Box>
