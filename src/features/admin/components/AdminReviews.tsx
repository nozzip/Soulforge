...
export const AdminReviews: React.FC = () => {
  ...
  const filteredReviews = allReviews.filter((review) => {
    ...
    if (reviewFilter === "high_rating")
      return matchesSearch && review.rating >= 4;
    if (reviewFilter === "low_rating")
        ...
        <Grid container spacing={3} alignItems="center">
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <Typography
              ...
              sx={{ mb: 2, maxWidth: "80%" }}
            >
              Genera un enlace mágico único para invitar a los aventureros a
              dejar su testimonio en los archivos.
            </Typography>
                    ...
                    <Stack direction="row" spacing={2} alignItems="center">
                      <Avatar
                        ...
                        sx={{
                          ...
                          border: 1,
                          borderColor: (t) =>
                            alpha(t.palette.secondary.main, 0.5),
                        }}
                      >
