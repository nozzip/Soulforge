    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          "&:hover": {
            boxShadow:
              "0 6px 16px rgba(212, 17, 17, 0.35), 0 0 20px rgba(197, 160, 89, 0.15)",
      ...
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          "&::after": {
            ...
            borderRadius: "inherit",
            background:
              "linear-gradient(135deg, rgba(197, 160, 89, 0.3), transparent, rgba(197, 160, 89, 0.1))",
            opacity: 0,
          ...
          "&:hover": {
            ...
            boxShadow:
              "0 12px 40px rgba(0,0,0,0.5), 0 0 30px rgba(197, 160, 89, 0.15)",
            "&::after": {
              opacity: 1,
            },
          },
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          "&:hover": {
            boxShadow:
              "0 6px 16px rgba(14, 165, 233, 0.4), 0 0 20px rgba(14, 165, 233, 0.2)",
            transform: "translateY(-2px)",
          },
        },
        outlined: {
      ...
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          "&::after": {
            ...
            borderRadius: "inherit",
            background:
              "linear-gradient(135deg, rgba(14, 165, 233, 0.3), transparent, rgba(14, 165, 233, 0.1))",
            opacity: 0,
            transition: "opacity 0.4s ease",
            pointerEvents: "none",
            zIndex: -1,
          ...
          "&:hover": {
            transform: "translateY(-6px)",
            boxShadow:
              "0 12px 40px rgba(0,0,0,0.6), 0 0 30px rgba(14, 165, 233, 0.2)",
            "&::after": {
              opacity: 1,
            },
          },
