...
export const getSEOForView = (view: ViewState, product?: Product | null): SEOData => {
    const baseUrl = window.location.origin;
    const baseName = 'ResinForge';

    switch (view) {
        case ViewState.HOME:
            return {
                title: `${baseName} | Miniaturas de Resina para D&D, Warhammer y más`,
                description: 'Impresiones de resina de alta calidad para tus juegos de rol y wargames. Encuentra dragones, héroes, monstruos y mucho más.',
        ...
        case ViewState.CATALOG:
            return {
                ...
                description: 'Explora nuestra colección completa de miniaturas de resina. D&D, Warhammer, Sci-Fi, Anime y más.',
                url: `${baseUrl}/catalog`
            };
        ...
        case ViewState.CART:
            return {
                ...
                description: 'Revisa los artefactos en tu carrito antes de completar tu pedido.',
            };
